...
-- Inserir estado com ID determinado, mesmo sendo autoincrementado

insert into estados (id, nome, sigla, região, populacao)
values (1000, Novo, NV, 'Sul', '4.64')

-- Caso ocorra um novo insert sem ID definido, ele sera o último ID +1. Neste caso, 1001